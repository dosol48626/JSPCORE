...
@WebServlet("/fileupload/MultiUpload.do")
@MultipartConfig(
...
public class MultiUploadServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        req.getRequestDispatcher("/ch13/MultiUploadMain.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        try{
            ...
            ArrayList<String> listFileNames = FileUtil.multipleFile(req, saveDirectory);
            for(String originalFileName : listFileNames){
